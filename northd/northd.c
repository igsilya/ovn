...
static struct ovn_lb_ip_set *ovn_lb_ip_set_create(void);
static void ovn_lb_ip_set_destroy(struct ovn_lb_ip_set *);
static struct ovn_lb_ip_set *ovn_lb_ip_set_clone(struct ovn_lb_ip_set *);
